...
<title>About | Hot Book Store</title>
						...
						<div class="bradcaump__inner text-center">
							...
							<nav class="bradcaump-content">
								<a class="breadcrumb_item" href="index.html">Home</a> <span
									...
									class="breadcrumb_item active">About us</span>
							</nav>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center">
								...
								<div class="single-skill">
									...
									<div class="progress">
										<div class="progress-bar wow fadeInLeft"
											data-wow-duration="0.8s" data-wow-delay=".5s"
					...
					<div class="col-lg-6 col-sm-12 col-12">
						<div class="content">
							...
							<p class="mt--20 mb--20">책으로 사람을 만나고 사람을 통해 서로 배우게 되며 배움으로 우리는
							오늘보다 나은 내일을 기대합니다. 우리 뜨거운 책방은 이렇게 시작하겠습니다.</p>
							<strong>뜨거운 책방</strong>
