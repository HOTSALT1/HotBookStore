					...
					<div class="col-lg-9 col-12">
									...
									<div class="product__info__main">
										...
										<div class="box-tocart d-flex">
											...
											<div class="product-addto-links clearfix">
												<a class="wishlist" href="#"></a> <a class="compare"
													href="#"></a> <a class="wishlist" href="#"></a> <a
													class="wishlist" href="#"></a>
											</div>
										</div>
						...
						<div class="product__info__detailed">
							...
							<div class="tab__container">
								...
								<div class="pro__tab_label tab-pane fade show" id="nav-details"
									role="tabpanel">
									<div class="description__attribute">
								...
								<div class="pro__tab_label tab-pane fade show"
									id="nav-book_index" role="tabpanel">
									<div class="description__attribute">
										<p>${book.book_index}</p>
									</div>
								</div>
										...
										<div class="review-fieldset">
												...
												<ul class="rating d-flex">
													...
													<div class="review-field-rating d-flex">
														...
														<ul id="writeStar" class="rating d-flex">
															...
															<li id="4" class="on "><i class="zmdi zmdi-star"></i></li>
															<li id="5" class="on "><i class="zmdi zmdi-star"></i></li>
														</ul>
													</div>
												</div>
											</div>
											<div class="review_form_field">
												...
												<div class="review-form-actions">
													<input class="btn" id="review_writeBtn" type="button"
					...
					<div class="col-lg-12">
						<div class="footer__widget footer__menu">
							<div class="ft__logo">
								...
								<p>because if you couldn't trust a bookstore, what could you
									trust?”</p>
							</div>
