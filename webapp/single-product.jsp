...
<head>
<meta charset="UTF-8">
<title>${book.title }-HotBook Store</title>
						...
						<div class="product__info__detailed">
							<div class="pro_details_nav nav justify-content-start"
								...
								<a class="nav-item nav-link active" data-toggle="tab"
									...
									data-toggle="tab" href="#nav-book_index" role="tab">목차</a> <a
									class="nav-item nav-link" data-toggle="tab" href="#nav-review"
									role="tab">리뷰 작성하기</a> <a class="nav-item nav-link"
									data-toggle="tab" href="#nav-review" role="tab">해당 책 리뷰 목록</a>
							</div>
							<div class="tab__container">
								<!-- Start 책소개 Tab Content -->
								<div class="pro__tab_label tab-pane fade active show"
											...
											<div class="review__ratings__type d-flex">
												<div class="review-ratings">
													<div class="rating-summary d-flex">
														<span>Quality</span><input type="hidden" id="score"
															value="${score }">
