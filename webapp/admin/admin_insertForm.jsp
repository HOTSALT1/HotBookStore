		...
		<div class="div1">
			...
			<div id="con">
				<div class="divName idx1">
					...
					<input type="text" name="title" id="title" class="required" placeholder="도서명을 입력하세요">
					<span id="titleDiv"></span>
				</div>
				<div class="div3 border-Tnone idx4">
					<label>부제목<span>|</span></label> 
					<input type="text" name="subTitle" id="subTitle" placeholder="부제목 입력하세요"> 
					<span id="subTitleDiv"></span>
				</div>
				<div class="div3 border-Tnone idx4">
					<label>저자명<span>|</span></label> 
					<input type="text" name="author" id="author" class="required" placeholder="저자명을 입력하세요"> 
					<span id="authorDiv"></span>
				</div>
				<div class="div3 border-Tnone idx5">
					<label>출판사<span>|</span></label> 
					<input type="text" name="pub" id="pub" placeholder="출판사를 입력하세요">
					<span id="publisherDiv"></span>
				</div>
				<div class="div3 border-Tnone idx6">
					<label>출간일<span>|</span></label> 
					<input type="text" name="p_date" id="p_date" placeholder="출간일을 입력하세요">
					<span id="publicationDateDiv"></span>
				</div>
				<div class="div3 border-Tnone idx7">
					<label>ISBN10<span>|</span></label> 
					<input type="text" name="isbn10" id="ISBN10" placeholder="ISBN10 입력">
					<span style="font-size: 14px; margin: 0 -8px 0 3px;">ISBN13</span>&nbsp;					
					<input type="text" name="isbn13" id="ISBN13" placeholder="ISBN13 입력">															
					<div id="ISBNDiv"></div>
				</div>				
				<div class="div3 border-Tnone idx7">
					<label>쪽수<span>|</span></label>
					<input type="text" name="page" id="page" placeholder="쪽수 입력하세요">
					<span id="pagesDiv"></span>													
				</div>				
				<div class="div3 border-Tnone idx7">
					<label>무게<span>|</span></label>
					<input type="text" name="weight" id="weight" placeholder="책무게를 입력하세요">
					<span id="weightDiv"></span>
				</div>				
				<div class="div3 border-Tnone idx7">
					<label>크기<span>|</span></label> 
					<input type="text" name="book_size" id="book_size" placeholder="책크기를 입력하세요">				
					<span id=sizeDiv></span>
				</div>				
				<div class="div3 border-Tnone idx7">
					<label>정가<span>|</span></label> 
					<input type="text" name="price" id="price" placeholder="정가를 입력하세요">				
					<span id="priceDiv"></span>
				</div>				
				<div class="div3 border-Tnone idx7">
					<label>판매가<span>|</span></label> 
					<input type="text" name="d_price" id="dprice" placeholder="판매가를 입력하세요">			
					<span id="ddpriceDiv"></span>
				</div>
				<div class="div3 border-Tnone idx7">
					<label>재고량<span>|</span></label> 
					<input type="text" name="stock" id="stock" placeholder="재고량을 입력하세요">		
					<span id="stockDiv"></span>
				</div>				
				<div class="div3 border-Tnone idx8" style="border-radius: 0 0 7px 7px;">
					<label>적립금<span>|</span></label> 
					<input type="text" name="point" placeholder="적립금을 입력하세요">		
