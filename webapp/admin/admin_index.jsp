...
<head>
	...
	<title>관리자 홈페이지 | Hot Book Store</title>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							<h2 class="title__be--2">Our <span class="color--theme">Book Store</span></h2>
							<p>책방 상품관리</p>
						</div>
					</div>
				</div>
		...
		<section class="wn__recent__post bg--gray ptb--80">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							<h2 class="title__be--2">Our <span class="color--theme">Community</span></h2>
							<p>뜨거운 책방 커뮤니티 관리페이지</p>
						</div>
					</div>
				</div>
				<div class="row mt--50">
			...
			<div class="container">
				...
				<div class="row mt--50">
					<div class="col-md-6 col-lg-4 col-sm-12">
						<div class="post__itam">
							<div class="content">
								<h3><a href="blog-details.html">주문 관리</a></h3>
								<p>주문관리 취소/환불/반품/교환 </p>
								<div class="post__time">
									<span class="day">Dec 06, 18</span>
									<div class="post-meta">
										<ul>
